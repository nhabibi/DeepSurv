...
def load_seer_data(
    ...
    # Identify categorical and numerical columns (matching SEER comorbid data schema)
    categorical_cols = ['race', 'marital_status', 'first_cancer_site']
    numerical_cols = [
        'age_first_diagnosis', 'age_second_diagnosis', 'months_between_cancers',
        'breast_stage', 'breast_grade', 'breast_tumor_size_cm', 'breast_positive_nodes',
        'breast_surgery', 'breast_radiation', 'breast_chemotherapy',
        'vaginal_stage', 'vaginal_grade', 'vaginal_tumor_size_cm',
        'vaginal_surgery', 'vaginal_radiation', 'vaginal_chemotherapy',
        'any_surgery', 'any_radiation', 'any_chemotherapy'
    ]
